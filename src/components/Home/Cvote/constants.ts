...
export const GOTOYOME_CHARS: Char[] = [
...
export const OREIMO_CHARS: Char[] = [
...
export const OREGAIRU_CHARS: Char[] = [
...
export const SAEKANO_CHARS: Char[] = [
...
export const MONOGATARI_CHARS: Char[] = [
